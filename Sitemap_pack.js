function Idrusgorontalo1_Load(t)
	...
	s(),sortBy="titleasc",sortPosts(sortBy),sortlabel(),mas_tamvan_MenuisiLoaded=!0,displaymas_tamvan_Menuisi2(),document.write()
}
...
function sortlabel()
	...
	s<postTitle.length;
		...
		{
		mas_tamvan_Labels=postLabels[s],firsti=t;
		do t+=1;
		while(postLabels[t]==mas_tamvan_Labels);
...
function displaymas_tamvan_Menuisi2()
	{
	for(var t=0,s=0;
	s<postTitle.length;
	)
		{
		mas_tamvan_Labels=postLabels[s],document.write("<p/>"),document.write('<span class="mas_tamvan_Label"><a href="/search/label/'+mas_tamvan_Labels+'">'+mas_tamvan_Labels+"</a></span><ol class='mas_tamvan_Postname'>"),firsti=t;
...
var periksa="100",postTitle=new Array,postUrl=new Array,postMp3=new Array,postDate=new Array,postLabels=new Array,postBaru=new Array,sortBy="titleasc",mas_tamvan_MenuisiLoaded=!1,numChars=250,postFilter="",numberfeed=0;
